...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const DOM = cacheDomElements({
    ...
    workModalTitle: "#work-modal-title",
    workModalSubtitle: "#work-modal-subtitle",
    workModalClose: "#work-modal-close",
    workModalList: "#work-modal-list",
    workModalEmpty: "#work-modal-empty",
